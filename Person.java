...
public abstract class Person {
    ...
    public void equip(GameItem item){
        if(GameItemManager.hasTag(item.getID(), "#Weapon"))
            equipWeapon((Weapon)item);
        else if (GameItemManager.hasTag(item.getID(), "#Head"))
            equipHead((Apparel)item);
        else if (GameItemManager.hasTag(item.getID(), "#Torso"))
            equipTorso((Apparel)item);
        else if (GameItemManager.hasTag(item.getID(), "#Legs"))
            equipLegs((Apparel)item);
        else {
            System.out.println("How in the world did you make this item?\nYou made is so poorly, I have absolutely  no clue what it is.");
        }
    }
