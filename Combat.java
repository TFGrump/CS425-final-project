...
public class Combat
{
    ...
    public ArrayList<Person>[] startCombat()
    {
        ...
        if (teamOne.length() == 0) {
            ...
            else System.out.println("You win, you winner!");
        }
    ...
    public Player findPlayer() { 
        return (isTeamOne ? teamOne.findPlayer() : teamTwo.findPlayer());
    }
    ...
    public int calcDamage(Person person) {
        ...
        if (weapon.getMag() > 0) {
            ...
            System.out.println(person.getFirstName() + " is reloading their weapon.");
            weapon.reload();
        }
        return totalDamage;
    }
    ...
    public void logAttack(Person personOne, Person personTwo, int damage)
    {
        if (damage > 0)
            ...
            System.out.println(personOne.getFirstName()+ " missed.");
    }
    ...
    {
        if (team) deadPeople[0].add(teamOne.removePerson(target));
        else deadPeople[1].add(teamTwo.removePerson(target));
    }
    ...
    private class Team
    {
        ...
        public Person personAt(int num){ 
            return team[num]; }
